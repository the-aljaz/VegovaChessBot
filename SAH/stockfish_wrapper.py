...
STOCKFISH_PATH = "SAH\stockfish\stockfish-windows-x86-64-avx2.exe" #MORE BIT RELATIVEN !!!!!!!!!!!!!!!!!!!!

stockfish = Stockfish(path=STOCKFISH_PATH, depth=18, parameters={"Threads": 64, "Minimum Thinking Time": 10}) # 18 is the depth of the engine
